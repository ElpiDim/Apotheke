...
function ProfileModal({ onClose }: { onClose: () => void }) {
  ...
  async function signOut() {
    try { await api<void>('/auth/logout', { method: 'POST' }); } catch { /* The local session is cleared either way. */ }
