  ...
  return (
    <div className="overflow-hidden rounded-[24px] border border-violet-100 bg-white shadow-[0_12px_36px_rgba(82,65,168,0.09)] dark:border-violet-800 dark:bg-[#211b35]">
      <header className="flex flex-wrap items-center gap-3 border-b border-violet-100 bg-[#fffdf9] px-4 py-3 dark:border-violet-800 dark:bg-[#1d1830] sm:px-5">
        ...
        <a href={fileUrl || undefined} download={document.currentVersion.originalFilename} aria-disabled={!fileUrl} className="flex items-center gap-2 rounded-xl bg-coral-500 px-3.5 py-2 text-xs font-semibold text-white hover:bg-coral-600 aria-disabled:pointer-events-none aria-disabled:opacity-50"><Download size={14} /> Download</a>
      </header>
